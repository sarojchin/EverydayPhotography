...
export const DAY_01_LESSON: Lesson = {
  ...
  coverImage: require("../../../assets/lesson01/1-selfie1.png"),
  steps: [
    {
      kind: "teach",
      title: "Selfies: Lighting and Angles",
    ...
    },
    {
      ...
      image: require("../../../assets/lesson01/1-selfie1.png"),
    },
    {
      kind: "teach",
      ...
      image: require("../../../assets/lesson01/2-selfie2.png"),
    },
    {
      kind: "teach",
      title: "Pose",
      ...
      image: require("../../../assets/lesson01/3-4angles.png"),
    },
  ],
};
