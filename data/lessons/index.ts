 ...
 *   1. Creating `data/lessons/<name>Lesson.ts` with `day: <N>` set.
...
import { LIGHTING_LESSON } from "./lightingLesson";

export const TOTAL_DAYS = 30;

/** Ordered registry of authored lessons. */
export const LESSONS: Lesson[] = [LIGHTING_LESSON];
...
export { LIGHTING_LESSON } from "./lightingLesson";
/** @deprecated Use `getLessonForDay(currentDay)` instead. Kept for backward compat. */
export const CURRENT_LESSON = LIGHTING_LESSON;
